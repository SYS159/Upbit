...
strategy_config = {
    ...
    "KRW-SOL":  {"rsi_threshold": 25, "rsi_max": 50, "ts_activation": 1.5},
    "KRW-XRP":  {"rsi_threshold": 25, "rsi_max": 50, "ts_activation": 1.5},
...
print("🚀 UTD_v5_5 실전 가동 시작 (로그 기록 기능 포함)")
send_discord_msg("🤖 **UTD_v5_5** 가동 시작\n- 종목당 25만 원\n- 로그 기록 활성화 (trade_log.csv)")
    ...
    try:
        ...
        for ticker in target_tickers:
            ...
            # --- [매도 로직] ---
                ...
                # 💡 [핵심 수정] profit_rate 대신 max_profit_rate 로 검사
