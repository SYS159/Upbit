...
strategy_config = {
    ...
    "KRW-ETH":  {"interval": "minute15", "ma_short": 5, "ma_long": 20, "use_pullback": True,  "use_trend_exit": True,  "trend_exit_fee": -1.5, "ts_activation": 1.5, "ts_callback": 0.25, "vol_window": 10, "rsi_threshold": 30, "rsi_max": 60, "use_rsi_drop": True, "vol_factor": 1.0, "use_btc_filter": False},
    "KRW-LINK": {"interval": "minute15", "ma_short": 3, "ma_long": 15, "use_pullback": False, "use_trend_exit": False, "trend_exit_fee": -1.0, "ts_activation": 1.0, "ts_callback": 0.25, "vol_window": 10, "rsi_threshold": 30, "rsi_max": 50, "use_rsi_drop": True, "vol_factor": 1.0, "use_btc_filter": False}
}
...
print("🚀 UTD_v8 멀티 타임프레임(15분/1시간봉) 실전 가동 시작")
send_discord_msg("🤖 **UTD_v8** 가동 시작\n- 🕒 멀티 타임프레임 장착 완료 (TAO,NEAR: 1시간 / 나머지: 15분)\n- 불필요한 노이즈 차단 및 최적 손익비 세팅 적용")
